...
@section('content')
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-showcase">
            ...
            <p class="subtitle">
                Explora nuestro catálogo exclusivo de prendas de vestir administradas por inteligencia artificial. Diseños adaptados perfectamente a tus medidas, preferencias y últimas tendencias.
            </p>
